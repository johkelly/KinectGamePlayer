...
namespace Microsoft.Samples.Kinect.SkeletonBasics
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Indicates whether or not skeleton frames are being recorded to file.
        /// </summary>
        private bool recording = false;

        /// <summary>
        /// Log file for writing during recording
        /// </summary>
        private StreamWriter log;

        /// <summary>
        /// Tracking ID of the user being recorded currently
        /// </summary>
        private int currentId = -1;

        /// <summary>
        /// Current frame of the sequence being recorded
        /// </summary>
        private int currentFrame = 0;

        private int currentInstanceNumberField = 0;
        /// <summary>
        /// Counter for which instance of the current gesture is beiing recorded
        /// </summary>
        public int currentInstanceNumber
        {
            get
            {
                return currentInstanceNumberField;
            }
            set
            {
                if (value != currentInstanceNumberField)
                {
                    currentInstanceNumberField = value;
                    PropertyChanged(this, new PropertyChangedEventArgs("currentInstanceNumber"));
                }
            }
        }
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e)
        {
            ...
            if (null == this.sensor)
            {
                this.directoryName.Text = Properties.Resources.NoKinectReady;
                this.directoryName.IsReadOnly = true;
            }
            ...
            FocusManager.SetFocusedElement(this, RecordButton);
        ...
        private void SensorSkeletonFrameReady(object sender, SkeletonFrameReadyEventArgs e)
        {
            ...
            using (DrawingContext dc = this.drawingGroup.Open())
            {
                ...
                TrackingBlock.Text = "Tracking " + currentId;
        ...
        private void writeToLog(Skeleton skel)
        {
            foreach (Joint j in skel.Joints)
            {
                ...
                log.WriteLine(currentFrame + " " + (int)j.JointType + " " + p.X + " " + p.Y + " " + p.Z);
            }
            currentFrame++;
        }
